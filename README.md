...
4. [Specdec acceptance](./experiments/specdec_offline_acceptance/): Offline simulation to get a feel for acceptance rates on audio tokens - not a real specdec setup with compute savings. See alpha ~0.66-0.76 when simulating 0.6B Qwen3-TTS drafting 1.7B.
